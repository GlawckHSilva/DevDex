...
export default async function Status() {
  ...
  return <main className="app-page container">
    ...
    <p className="notice">Beta {beta.enabled ? "aberta" : "pausada"} para usuários autenticados. A primeira zona RPG inclui escolha de personagem, cinco inimigos, três vidas, pesquisa, elite e chefe, sempre sem armazenar o código-fonte.</p>
  </main>;
}
