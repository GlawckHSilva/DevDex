...
export default async function Status() {
  ...
  return <main className="app-page container">
    ...
    <span className="kicker">PROJECT STATUS</span><h2>DevDex Public Beta v0.2</h2>
    ...
    <p className="notice">Beta {beta.enabled ? "aberta" : "pausada"} para usuários autenticados. As quatro tecnologias são campanhas RPG independentes com personagem, três vidas, pesquisa, elites e bosses, sempre sem armazenar o código-fonte.</p>
  </main>;
}
