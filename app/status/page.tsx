...
export default async function Status() {
  ...
  return <main className="app-page container">
    ...
    <p className="notice">Beta {beta.enabled ? "aberta" : "pausada"} para usuários autenticados. As seis tecnologias são campanhas RPG independentes com personagem, cinco corações globais, dicas, elites e bosses. O código só é salvo no histórico privado quando o aluno adquire Memória de Código.</p>
  </main>;
}
