...
export default async function Status() {
  ...
  return <main className="app-page container">
    ...
    <p className="notice">Beta {beta.enabled ? "aberta" : "pausada"} para usuários autenticados. As cinco tecnologias são campanhas RPG independentes com personagem, três vidas, pesquisa, elites e bosses, sempre sem armazenar o código-fonte.</p>
  </main>;
}
