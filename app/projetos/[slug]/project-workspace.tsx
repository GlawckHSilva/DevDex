...
type Project = { slug: string; title: string; description: string; introduction: string; deadlineDays: number; state: "available" | "in_progress" | "completed"; completedSteps: number; files: FileItem[]; steps: Step[] };
