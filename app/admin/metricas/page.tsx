...
export default async function MetricsPage() {
  const user = await requireAdminUser("/admin/metricas");
  ...
  return <main className="dashboard-shell">
    <AuthenticatedSidebar user={user} activePath="/admin/metricas" />
    <section className="app-page container metrics-page">
