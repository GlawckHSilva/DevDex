...
type Submission = { ok: boolean; message: string; columns?: string[]; rows?: SqlValue[][]; results?: BattleResultItem[]; gainedXp?: number; unlockedSlug?: string | null; battle?: { lives: number; state: BattleView["state"]; hint?: string } | null };
